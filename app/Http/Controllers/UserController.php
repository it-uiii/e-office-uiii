...
class UserController extends Controller
{
    ...
    {
        $this->middleware('user_permission:user-list|user-create|user-edit|user-delete', ['only' => ['index', 'store']]);
        $this->middleware('user_permission:user-create', ['only' => ['create', 'store']]);
        $this->middleware('user_permission:user-edit', ['only' => ['edit', 'update']]);
        $this->middleware('user_permission:user-delete', ['only' => ['destroy']]);
    }
