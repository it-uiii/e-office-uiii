...
<head>
    ...
    <title>Laporan Kinerja Harian - {{ $performance_reports->first()->report_created_by->name }} - {{ tgl($performance_reports->first()->date) }}</title>
    <style>
        .page-break {
...
<body>
    ...
    @foreach ($performance_reports as $data)
