            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @can('role-edit')
                        <a class="btn btn-warning" href="/roles/{{ $role->id }}/edit"><i class="fas fa-pen"></i></a>    
                        @endcan
                        @can('role-delete')
                        <form action="/roles/{{ $role->id }}" method="post" class="d-inline">
                            @method('delete')
                            @csrf
                            <button class="btn btn-danger" onclick="return confirm('Are you sure want delete this role?')">
